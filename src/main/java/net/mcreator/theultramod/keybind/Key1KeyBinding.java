...
import net.mcreator.theultramod.procedures.Key1OnKeyPressedProcedure;
...
public class Key1KeyBinding extends TheultramodElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public Key1KeyBinding(TheultramodElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.key1", GLFW.GLFW_KEY_P, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity) {
			...
			return;
		{
			...
			Key1OnKeyPressedProcedure.executeProcedure($_dependencies);
		}
	}
}
