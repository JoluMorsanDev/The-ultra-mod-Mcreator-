...
import net.mcreator.theultramod.procedures.FletcherkeyOnKeyPressedProcedure;
...
public class FletcherkeyKeyBinding extends TheultramodElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public FletcherkeyKeyBinding(TheultramodElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.fletcherkey", GLFW.GLFW_KEY_ESCAPE, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity) {
			...
			return;
		{
			...
			FletcherkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
		}
	}
}
